...
export class StoreComponent implements OnInit {
  ...
  allProducts: Product[] = [
    ...
    {
      id: 4,
      name: 'Non-Slip Yoga Blocks',
      price: 17.99,
      image: '/images/wavex-yoga-blocks.png',
      category: 'Yoga Accessories',
      description:
        'Supportive, durable foam blocks for improved stability and alignment',
    },
    {
      id: 5,
...

    {
      ...
      name: 'Wavex Backpack',
      price: 18.99,
      image: '/images/wavex-backpack.png',
      category: 'Bags',
    ...
    },
    {
      ...
      name: 'Wavex tote bag',
      price: 19.99,
      image: '/images/wavex-tote-bag.jpg',
      category: 'Bags',
      description: 'Durable, branded',
    },
    {
    ...
    },
    {
      ...
      price: 29.99,
      image: '/images/wavex-leggings.jpg',
      category: 'Apparel Collection',
