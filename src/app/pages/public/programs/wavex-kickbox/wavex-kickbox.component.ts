...
@Component({
  selector: 'app-wavex-kickbox',
  imports: [FormsModule],
  templateUrl: './wavex-kickbox.component.html',
  styleUrl: './wavex-kickbox.component.css',
})
export class WavexKickboxComponent implements OnInit {
  today = new Date();
