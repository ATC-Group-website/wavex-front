...
@Component({
  selector: 'app-wavex-circuit',
  imports: [FormsModule],
  templateUrl: './wavex-circuit.component.html',
  styleUrl: './wavex-circuit.component.css',
})
export class WavexCircuitComponent implements OnInit {
  today = new Date();
